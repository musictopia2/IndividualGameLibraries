    ...
    public class FiveCrownsGraphicsCP : ObservableObject, IDeckGraphicsCP
    {
        ...
        private void DrawSuit(SKCanvas canvas, SKRect rect_Card)
        {
            switch (Suit)
            {
                case EnumSuitList.Clubs:
                    {
                        canvas.DrawCardSuit(BasicGameFramework.RegularDeckOfCards.EnumSuitList.Clubs, rect_Card, _greenPaint!, null);
                        break;
                    }

                case EnumSuitList.Diamonds:
                    {
                        canvas.DrawCardSuit(BasicGameFramework.RegularDeckOfCards.EnumSuitList.Diamonds, rect_Card, _bluePaint!, null);
                        break;
                    }

                case EnumSuitList.Hearts:
                    {
                        canvas.DrawCardSuit(BasicGameFramework.RegularDeckOfCards.EnumSuitList.Hearts, rect_Card, _redPaint!, null);
                        break;
                    }

                case EnumSuitList.Spades:
                    {
                        canvas.DrawCardSuit(BasicGameFramework.RegularDeckOfCards.EnumSuitList.Spades, rect_Card, _blackPaint!, null);
                        break;
                    }

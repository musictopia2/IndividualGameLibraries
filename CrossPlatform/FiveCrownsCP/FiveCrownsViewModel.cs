...
{
    public class FiveCrownsViewModel : BasicCardGamesVM<FiveCrownsCardInformation, FiveCrownsPlayerItem, FiveCrownsMainGameClass>
    {
        public FiveCrownsViewModel(ISimpleUI tempUI, IGamePackageResolver tempC, BasicData thisData) : base(tempUI, tempC, thisData) { }
        ...
        public TempSetsViewModel<EnumSuitList, EnumColorList, FiveCrownsCardInformation>? TempSets;
        public MainSetsViewModel<EnumSuitList, EnumColorList, FiveCrownsCardInformation, PhaseSet, SavedSet>? MainSets;
        ...
        protected override void EndInit()
        {
            ...
            BackCommand = new OutOfTurnCommand(this, items =>
            {
                ...
                FiveCrownsPlayerItem thisPlayer = MainGame!.PlayerList!.GetSelf();
            ...
            TempSets = new TempSetsViewModel<EnumSuitList, EnumColorList, FiveCrownsCardInformation>();
            MainSets = new MainSetsViewModel<EnumSuitList, EnumColorList, FiveCrownsCardInformation, PhaseSet, SavedSet>(this);
            TempSets.HowManySets = 6; //no feature for autoselected.
            TempSets.Init(this);
            TempSets.SetClickedAsync += TempSets_SetClickedAsync;
            PlayerHand1!.AutoSelect = BasicGameFramework.DrawableListsViewModels.HandViewModel<FiveCrownsCardInformation>.EnumAutoType.SelectAsMany;

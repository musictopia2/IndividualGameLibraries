...
{
    [SingletonGame]
    [AutoReset] //i think this will need that part (?)
    public class CandylandBoardProcesses
    {
        ...
        public bool WillMissNextTurn(CandylandMainGameClass mainGame)
        {
        ...
        public void ClearBoard(CandylandMainGameClass mainGame)
        {

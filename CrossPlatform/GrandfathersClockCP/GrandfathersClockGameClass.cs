...
{
    [SingletonGame]
    public class GrandfathersClockGameClass : SolitaireGameClass<GrandfathersClockSaveInfo>
    {
        public GrandfathersClockGameClass(IBasicSolitaireVM thisMod) : base(thisMod) { }

...
{
    [SingletonGame]
    public class EasyGoSolitaireGameClass : SolitaireGameClass<EasyGoSolitaireSaveInfo>
    {
        public EasyGoSolitaireGameClass(IBasicSolitaireVM thisMod) : base(thisMod) { }

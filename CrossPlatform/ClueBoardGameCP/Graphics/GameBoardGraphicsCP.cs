...
namespace ClueBoardGameCP.Graphics
{
    ...
    public class GameBoardGraphicsCP : BaseGameBoardCP<PawnPiecesCP<EnumColorChoice>>
    {
        ...
        private CustomBasicList<Room>? _arr_Rooms; // 0 based here unless i use dictionary.
        private Hashtable? _arr_Squares;
        ...
        {
            Room thisRoom;
            thisRoom = _arr_Rooms![room - 1];  // its minus, not plus
        ...
        private int SpaceClicked(float x, float y) //hopefully this is enough now.
        {
            ...
            for (int_Row = 1; int_Row <= 25; int_Row++)
            {
                for (int_Col = 1; int_Col <= 24; int_Col++)
                {
                    ...
                    if ((_arr_Squares!.Contains(pt_Temp)))
                    {
                        str_Name = _arr_Squares[pt_Temp].ToString(); //hopefully that works.
        ...
        private int RoomClicked(float x, float y)
        {
            ...
            foreach (var obj_Room in _arr_Rooms!)
            {
                z += 1;
        ...
        protected override async Task ClickProcessAsync(SKPoint thisPoint)
        {
            ...
            if (_gameContainer.CanClickSpace() == false)
            {
                return;
            }
            if (_gameContainer.SpaceClickedAsync == null)
            {
                throw new BasicBlankException("Nobody is handling space clicked.  Rethink");
            }
            if (_gameContainer.RoomClickedAsync == null)
            {
                throw new BasicBlankException("Nobody is handling room clicked.  Rethink");
            }

            int spaceIndex = SpaceClicked(thisPoint.X, thisPoint.Y);
            if (spaceIndex > 0)
            {
                await _gameContainer.ProcessCustomCommandAsync(_gameContainer.SpaceClickedAsync, spaceIndex);
                return;
            }
            int roomIndex = RoomClicked(thisPoint.X, thisPoint.Y);
            if (roomIndex > 0)
            {
                await _gameContainer.ProcessCustomCommandAsync(_gameContainer.RoomClickedAsync, roomIndex);
                return;
            }
        }
        ...
        private void InitializeRooms()
        {
            ...
            Door obj_TempDoor;
            SKRect TempRect;
            _arr_Squares = new Hashtable();
            // *** Create the rooms
            _arr_Rooms = new CustomBasicList<Room>();
            // ******************************
            // *** Create the kitchen
        ...
        private void InitializeSquares()
        {
            ...
            // *** Create the spaces
            _arr_Squares = new Hashtable();
            _arr_Squares.Add(new SKPoint(8, 2), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(9, 2), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(8, 3), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(9, 3), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(9, 4), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(8, 4), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            int_Col = 9;
            while (int_Col >= 2)
            {
                _arr_Squares.Add(new SKPoint(int_Col, 5), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
                int_Col -= 1;
            }
            for (int_Col = 2; int_Col <= 9; int_Col++)
                _arr_Squares.Add(new SKPoint(int_Col, 6), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(9, 7), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(8, 7), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(7, 7), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            for (int_Col = 8; int_Col <= 16; int_Col++)
                _arr_Squares.Add(new SKPoint(int_Col, 8), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            int_Row = 7;
            while (int_Row >= 2)
            {
                _arr_Squares.Add(new SKPoint(16, int_Row), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
                int_Row -= 1;
            }
            for (int_Row = 2; int_Row <= 7; int_Row++)
                _arr_Squares.Add(new SKPoint(17, int_Row), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            for (int_Col = 18; int_Col <= 23; int_Col++)
                _arr_Squares.Add(new SKPoint(int_Col, 7), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            int_Col = 23;
            while (int_Col >= 17)
            {
                _arr_Squares.Add(new SKPoint(int_Col, 8), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            ...
            while (int_Col >= 15)
            {
                _arr_Squares.Add(new SKPoint(int_Col, 9), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
                int_Col -= 1;
            }
            // 69-75
            _arr_Squares.Add(new SKPoint(8, 9), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(9, 9), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(9, 10), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(8, 10), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(7, 11), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(8, 11), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(9, 11), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            // 76-83
            for (int_Col = 2; int_Col <= 9; int_Col++)
                _arr_Squares.Add(new SKPoint(int_Col, 12), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            // 84-89
            for (int_Row = 10; int_Row <= 12; int_Row++)
            {
                for (int_Col = 15; int_Col <= 16; int_Col++)
                    _arr_Squares.Add(new SKPoint(int_Col, int_Row), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            }
            // 90-98
            ...
            for (int_Col = 7; int_Col <= 19; int_Col++)
                _arr_Squares.Add(new SKPoint(int_Col, 16), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            // 118-134
            for (int_Col = 7; int_Col <= 23; int_Col++)
                _arr_Squares.Add(new SKPoint(int_Col, 17), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            // 135-141
            for (int_Col = 2; int_Col <= 8; int_Col++)
                _arr_Squares.Add(new SKPoint(int_Col, 18), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            // 142-148
            for (int_Col = 17; int_Col <= 23; int_Col++)
                _arr_Squares.Add(new SKPoint(int_Col, 18), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            // 149-155
            for (int_Col = 2; int_Col <= 8; int_Col++)
                _arr_Squares.Add(new SKPoint(int_Col, 19), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            // 156-162
            _arr_Squares.Add(new SKPoint(17, 19), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(18, 19), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(6, 20), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(7, 20), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(8, 20), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(17, 20), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(18, 20), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            // 163-171
            ...
            _arr_Squares.Add(new SKPoint(9, 24), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(15, 24), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(16, 24), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(17, 24), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(17, 23), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(18, 23), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(18, 22), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(17, 22), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(17, 21), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            _arr_Squares.Add(new SKPoint(18, 21), "S" + System.Convert.ToString((_arr_Squares.Count + 1)));
            // *** Create the entryways
            _arr_Squares.Add(new SKPoint(17, 1), "b1");
            _arr_Squares.Add(new SKPoint(24, 8), "b2");
            _arr_Squares.Add(new SKPoint(15, 25), "b3");
            _arr_Squares.Add(new SKPoint(9, 25), "b4");
            _arr_Squares.Add(new SKPoint(1, 19), "b5");
            _arr_Squares.Add(new SKPoint(1, 6), "b6");
        }
        private SKPoint PositionForStartSpace(int startNumber) // i think make private since this should be drawing the stuff on the board as well
        {
            ...
            for (int_Row = 1; int_Row <= 25; int_Row++)
            {
                for (int_Col = 1; int_Col <= 24; int_Col++)
                {
                    ...
                    if ((_arr_Squares!.Contains(pt_Temp)))
                    {
                        str_Name = _arr_Squares[pt_Temp].ToString();
        ...
        public GameSpace RoomSpaceInfo(int room)
        {
            ...
            Room obj_Room;
            var bounds = SKRect.Create(0, 0, ClueBoardGameGameContainer.BoardWidth, ClueBoardGameGameContainer.BoardHeight);
            ...
            dbl_SquareHeight = bounds.Height / 25;
            int y;
            obj_Room = _arr_Rooms![room - 1]; // because 0 based.
        ...
        protected override void DrawBoard(SKCanvas canvas)
        {
            _didDraw = true;
            var bounds = GetBounds();
            ClueBoardGameGameContainer.BoardHeight = bounds.Height;
            ClueBoardGameGameContainer.BoardWidth = bounds.Width;
            canvas.Clear();
            PrivateDrawBoard(canvas);
            if (_gameContainer.RoomList.Count == 0)
            ...
            SKPoint newPoint;
            IProportionImage thisP = _gameContainer.Resolver.Resolve<IProportionImage>();
            if (_gameContainer.Test.DoubleCheck)
            {
                //will use blue piece alone as well.
                int count = _arr_Squares!.Count - 6; //i think
                count.Times(y =>
                {
                    var thisPoint = PositionForBoardPiece(y);
                    string color;
                    if (y == _gameContainer.TempClicked)
                        color = cs.Red;
                    else
                        color = cs.Blue;
            ...
            {
                x++;
                tempCol1 = _gameContainer.WeaponsInRoom(x);
                if (thisRoom.Space == null)
                    return;
                _gameContainer.Position.ClearArea(thisRoom.Space);
                tempCol1.ForEach(thisWeapon =>
                {
                    SKSize weaponSize = thisWeapon.DefaultSize.GetSizeUsed(thisP.Proportion);
                    newPoint = _gameContainer.Position.GetPosition(thisRoom.Space, weaponSize.Width, weaponSize.Height);
                    ...
                    _gameContainer.Position.AddRectToArea(thisRoom.Space, SKRect.Create(newPoint.X, newPoint.Y, (float)otherWeapon.ActualWidth, (float)otherWeapon.ActualHeight));
                    otherWeapon.Location = newPoint;
                    otherWeapon.NeedsToClear = false;
                    otherWeapon.DrawImage(canvas);
                });
                tempCol2 = _gameContainer.CharactersInRoom(x);
                tempCol2.ForEach(thisCharacter =>
                {
                    ...
                    newPoint = _gameContainer.Position.GetPosition(thisRoom.Space, (float)otherCharacter.ActualWidth, (float)otherCharacter.ActualHeight);
                    otherCharacter.MainColor = thisCharacter.MainColor;
                    thisRoom.Space.PieceList.Add(otherCharacter);
                    _gameContainer.Position.AddRectToArea(thisRoom.Space, SKRect.Create(newPoint.X, newPoint.Y, (float)otherCharacter.ActualWidth, (float)otherCharacter.ActualHeight));
                    otherCharacter.Location = newPoint;
                    otherCharacter.NeedsToClear = false;
                    otherCharacter.DrawImage(canvas);
                });
            }
            tempCol2 = _gameContainer.CharactersOnStart();
            tempCol2.ForEach(thisCharacter =>
            {
                var otherCharacter = GetGamePiece(thisCharacter.MainColor, PositionForStartSpace(thisCharacter.FirstNumber));
                otherCharacter.DrawImage(canvas);
            });
            tempCol2 = _gameContainer.CharactersOnBoard();
            tempCol2.ForEach(thisCharacter =>
            {

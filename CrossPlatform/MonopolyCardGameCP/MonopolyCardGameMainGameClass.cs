...
namespace MonopolyCardGameCP
{
    ...
    {
        public MonopolyCardGameMainGameClass(IGamePackageResolver container) : base(container) { }
        private bool _doContinue;
        private MonopolyCardGameViewModel? ThisMod;

        public override void Init() //decided to have all the code under init to prevent overflow issues.
        {
            base.Init();
            ThisMod = MainContainer.Resolve<MonopolyCardGameViewModel>();
        }
        ...
        protected override async Task LastPartOfSetUpBeforeBindingsAsync()
        {
            ...
            {
                thisPlayer.TradePile!.ClearBoard(ThisMod!.Deck1!.DrawCard());
            });
        ...
        async Task IMiscDataNM.MiscDataReceived(string status, string content)
        {
            switch (status)
            {
                ...
                case "trade1":
                    ...
                    ThisCheck!.IsEnabled = true; //wait for more
                    return;
                case "trade2":
                    ...
                    var tempCollection = thisSend.CardList.GetNewObjectListFromDeckList(DeckList!).ToRegularDeckDict();
        ...
        public async Task ProcessGoingOutAsync()
        {
            ...
            ThisMod!.Status = SingleInfo.NickName + " went out.  Finishing the round";
            PlayerList.ForEach(thisPlayer =>
            {
        ...
        {
            tempPlayer.TradePile = new TradePile(ThisMod!, tempPlayer.Id); //hopefully this simple (?)
        }

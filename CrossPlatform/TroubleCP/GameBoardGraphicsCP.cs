...
namespace TroubleCP
{
    ...
    public class GameBoardGraphicsCP : BaseGameBoardCP<MarblePiecesCP<EnumColorChoice>>
    {
        ...
        private readonly TroubleViewModel _thisMod;
        private readonly TroubleMainGameClass _mainGame;
        private readonly IFirstPaint _firstPaint;
        ...
        public GameBoardGraphicsCP(IGamePackageResolver mainContainer) : base(mainContainer)
        {
            ...
            _thisMod = mainContainer.Resolve<TroubleViewModel>();
            _mainGame = mainContainer.Resolve<TroubleMainGameClass>();
            _firstPaint = mainContainer.Resolve<IFirstPaint>();
        ...
        protected override void ClickProcess(SKPoint thisPoint)
        {
            ...
            {
                if (_thisMod.RollCommand!.CanExecute(null!) == true)
                    _thisMod.RollCommand.Execute(null!);
                return;
            }
            if (_isTest == false)
            {
        ...
        protected override void DrawBoard(SKCanvas canvas)
        {
            ...
            thisMarble = GetGamePiece(_mainGame.SingleInfo!.Color.ToColor(), new SKPoint(0, 0));

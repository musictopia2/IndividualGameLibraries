...
namespace TroubleCP
{
    public class TroubleViewModel : BoardDiceGameVM<EnumColorChoice, MarblePiecesCP<EnumColorChoice>,
        TroublePlayerItem, TroubleMainGameClass, int>
    {
        ...
        public TroubleViewModel(ISimpleUI tempUI, IGamePackageResolver tempC, BasicData thisData) : base(tempUI, tempC, thisData) { }

...
namespace FlinchCP
{
    public class PublicPilesViewModel : SimpleControlViewModel
    {
        ...
        public PublicPilesViewModel(IBasicGameVM thisMod) : base(thisMod)
        {
            PileCommand = new ControlCommand<BasicPileInfo<FlinchCardInformation>>(this, async Items =>
            {
                if (PileClickedAsync == null)
                    return;
                await PileClickedAsync.Invoke(PileList.IndexOf(Items));

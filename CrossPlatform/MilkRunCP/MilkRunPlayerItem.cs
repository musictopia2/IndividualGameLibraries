...
namespace MilkRunCP
{
    public class MilkRunPlayerItem : PlayerSingleHand<MilkRunCardInformation>
    {
        ...
        public void LoadPiles(MilkRunMainGameClass mainGame)
        {
            _mainGame = mainGame;
            StrawberryPiles = new BasicMultiplePilesCP<MilkRunCardInformation>(mainGame.ThisMod!);
            ...
            ChocolatePiles = new BasicMultiplePilesCP<MilkRunCardInformation>(mainGame.ThisMod!);

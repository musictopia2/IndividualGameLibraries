...
{
    public class AgnesSolitaireViewModel : SolitaireMainViewModel<AgnesSolitaireSaveInfo>
    {
        ...
        public AgnesSolitaireViewModel(ISimpleUI tempUI, IGamePackageResolver tempC) : base(tempUI, tempC) { }
    }
}
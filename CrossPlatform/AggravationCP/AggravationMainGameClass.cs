...
{
    [SingletonGame]
    public class AggravationMainGameClass : BoardDiceGameClass<EnumColorChoice, MarblePiecesCP<EnumColorChoice>,
        AggravationPlayerItem, AggravationSaveInfo, int>
    {
        public AggravationMainGameClass(IGamePackageResolver container) : base(container) { }
        internal AggravationViewModel? ThisMod;
        ...
        {
            base.Init();
            ThisMod = MainContainer.Resolve<AggravationViewModel>();
        }
        public override Task FinishGetSavedAsync()
        {
            ...
            if (DidChooseColors)
                ThisMod.GameBoard1.SendTurn(); //i think.

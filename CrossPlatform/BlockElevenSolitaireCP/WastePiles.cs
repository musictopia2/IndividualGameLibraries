...
namespace BlockElevenSolitaireCP
{
    ...
    {
        private readonly BlockElevenSolitaireViewModel _thisMod;
        public WastePiles(IBasicGameVM thisMod) : base(thisMod)
        {
            _thisMod = (BlockElevenSolitaireViewModel)thisMod;
        }
        ...
        {
            if (_thisMod.DeckPile!.IsEndOfDeck() == true)
            ...
            thisCard = _thisMod.DeckPile.DrawCard();

...
namespace MonasteryCardGameCP
{
    public class RummySet : SetInfo<EnumSuitList, EnumColorList, MonasteryCardInfo, SavedSet>
    {
        ...
        {
            CanExpandRuns = true;
            _mainGame = thisMod.MainContainer!.Resolve<MonasteryCardGameMainGameClass>();
        }
        ...
        {
            return _mainGame.ThisData!.IsXamarinForms == false; //well see how it works later.
        }
        ...
        public DeckRegularDict<MonasteryCardInfo> NeedList(int position)
        {
            ...
            if (thisCard.Value == EnumCardValueList.LowAce && _setType == EnumWhatSets.DoubleRun)
                thisCard = HandList[1];
            var entireList = _mainGame.Rummys!.EntireList;

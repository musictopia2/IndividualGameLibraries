...
namespace PaydayCP.Graphics
{
    public class CardGraphicsCP : ObservableObject, IDeckGraphicsCP
    {
        ...
        private void DraweDealData(SKCanvas canvas, SKRect bounds)
        {
            ...
            var rect_BottomLeft = SKRect.Create(rect_Bottom.Left, rect_Bottom.Top, rect_Bottom.Width / 2, rect_Bottom.Height);
            var rect_BottomRight = SKRect.Create(rect_Bottom.Left + (rect_Bottom.Width / 2), rect_Bottom.Top, rect_Bottom.Width / 2, rect_Bottom.Height);
            ...
            switch (Index)
            {
                ...
                case 3:
                    {
                        rect_TopLeft = SKRect.Create(rect_Top.Left, rect_Top.Top, rect_Top.Width * 0.3f, rect_Top.Height);
                        rect_TopRight = SKRect.Create((rect_Top.Left + rect_TopLeft.Width) - 10, rect_Top.Top, rect_Top.Width - rect_TopLeft.Width, rect_Top.Height);
                        DrawDealText(canvas, "Cost      $3,500", fontSize, rect_BottomLeft);
                        DrawDealText(canvas, "Value     $6,000", fontSize, rect_BottomRight);
                ...
                case 5:
                    {
                        rect_TopLeft = SKRect.Create(rect_Top.Left, rect_Top.Top, rect_Top.Width * 0.3f, rect_Top.Height);
                        rect_TopRight = SKRect.Create(rect_Top.Left + rect_TopLeft.Width, rect_Top.Top, rect_Top.Width - rect_TopLeft.Width - 10, rect_Top.Height);
                        ...
                        DrawComedy(canvas, SKRect.Create(rect_TopLeft.Left + (rect_TopLeft.Width * 0.1f), rect_TopLeft.Top + (rect_TopLeft.Height * 0.1f), rect_TopLeft.Width * 1, rect_TopLeft.Height * 0.8f));
                        break;
                    }
                ...
                case 6:
                    {
                        rect_TopLeft = SKRect.Create(rect_Top.Left, rect_Top.Top, rect_Top.Width * 0.3f, rect_Top.Height);
                        rect_TopRight = SKRect.Create(rect_Top.Left + rect_TopLeft.Width, rect_Top.Top, rect_Top.Width - rect_TopLeft.Width - 20, rect_Top.Height);
                        ...
                        DrawJewelry(canvas, SKRect.Create(rect_TopLeft.Left + (rect_TopLeft.Width * 0.1f), rect_TopLeft.Top + (rect_TopLeft.Height * 0.1f), rect_TopLeft.Width * 1, rect_TopLeft.Height * 0.8f));
                        break;
                    }
                ...
                case 9:
                    {
                        rect_TopRight = SKRect.Create(rect_Top.Left, rect_Top.Top, rect_Top.Width, rect_Top.Height / 2);
                        rect_TopLeft = SKRect.Create(rect_Top.Left, rect_Top.Top + (rect_Top.Height / 2), rect_Top.Width, rect_Top.Height / 2);
                ...
                case 10:
                    {
                        ...
                        DrawNoodles(canvas, SKRect.Create(rect_TopLeft.Left + (rect_TopLeft.Width * 0.1f), rect_TopLeft.Top + (rect_TopLeft.Height * 0.1f), rect_TopLeft.Width * 1, rect_TopLeft.Height * 0.8f));
                        break;
                    }
                ...
                case 11:
                    {
                        ...
                        DrawSafari(canvas, SKRect.Create(rect_TopLeft.Left + (rect_TopLeft.Width * 0.1f), rect_TopLeft.Top + (rect_TopLeft.Height * 0.1f), rect_TopLeft.Width * 1, rect_TopLeft.Height * 0.8f));
                        break;
                    }

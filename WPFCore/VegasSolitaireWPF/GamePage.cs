...
namespace VegasSolitaireWPF
{
    public class GamePage : SinglePlayerWindow<VegasSolitaireViewModel>
    {
        ...
        protected async override void AfterGameButton()
        {
            ...
            scoresAlone.AddRow("Score", nameof(VegasSolitaireViewModel.Money), thisCon);
            var tempGrid = scoresAlone.GetContent;
            var autoBut = GetGamingButton("Auto Make Move", nameof(VegasSolitaireViewModel.AutoMoveCommand));

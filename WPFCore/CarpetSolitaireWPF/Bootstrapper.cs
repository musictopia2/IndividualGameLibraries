...
{
    public class Bootstrapper : SinglePlayerBootstrapper<CarpetSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<CarpetSolitaireShellViewModel>(); //hopefully okay.

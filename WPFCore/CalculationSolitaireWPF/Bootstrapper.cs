...
namespace CalculationSolitaireWPF
{
    public class Bootstrapper : SinglePlayerBootstrapper<CalculationSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<CalculationSolitaireShellViewModel>(); //hopefully okay.

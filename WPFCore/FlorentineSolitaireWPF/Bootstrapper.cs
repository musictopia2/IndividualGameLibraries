...
{
    public class Bootstrapper : SinglePlayerBootstrapper<FlorentineSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<FlorentineSolitaireShellViewModel>(); //hopefully okay.

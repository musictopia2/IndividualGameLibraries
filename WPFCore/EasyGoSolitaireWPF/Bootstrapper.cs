...
namespace EasyGoSolitaireWPF
{
    public class Bootstrapper : SinglePlayerBootstrapper<EasyGoSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<EasyGoSolitaireShellViewModel>(); //hopefully okay.

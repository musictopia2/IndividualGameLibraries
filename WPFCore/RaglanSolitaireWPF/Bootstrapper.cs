...
{
    public class Bootstrapper : SinglePlayerBootstrapper<RaglanSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<RaglanSolitaireShellViewModel>(); //hopefully okay.

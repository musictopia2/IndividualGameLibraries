...
{
    public class Bootstrapper : SinglePlayerBootstrapper<LittleSpiderSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<LittleSpiderSolitaireShellViewModel>(); //hopefully okay.

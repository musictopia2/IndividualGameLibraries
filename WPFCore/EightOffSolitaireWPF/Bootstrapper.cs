...
{
    public class Bootstrapper : SinglePlayerBootstrapper<EightOffSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<EightOffSolitaireShellViewModel>(); //hopefully okay.

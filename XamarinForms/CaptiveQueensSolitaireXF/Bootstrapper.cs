...
{
    public class Bootstrapper : SinglePlayerBootstrapper<CaptiveQueensSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<CaptiveQueensSolitaireShellViewModel>(); //hopefully okay.

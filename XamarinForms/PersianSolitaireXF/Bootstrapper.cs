...
{
    public class Bootstrapper : SinglePlayerBootstrapper<PersianSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<PersianSolitaireShellViewModel>(); //hopefully okay.

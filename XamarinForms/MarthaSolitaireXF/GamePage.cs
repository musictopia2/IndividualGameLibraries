...
{
    public class GamePage : SinglePlayerGamePage<MarthaSolitaireViewModel>
    {
        ...
        protected override async Task AfterGameButtonAsync()
        {
            ...
            var autoBut = GetSmallerButton("Auto Make Move", nameof(MarthaSolitaireViewModel.AutoMoveCommand));

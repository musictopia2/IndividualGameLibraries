...
{
    public class Bootstrapper : SinglePlayerBootstrapper<FreeCellSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<FreeCellSolitaireShellViewModel>(); //hopefully okay.

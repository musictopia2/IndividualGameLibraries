...
{
    public class Bootstrapper : SinglePlayerBootstrapper<BeleaguredCastleShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<BeleaguredCastleShellViewModel>(); //hopefully okay.

...
namespace KlondikeSolitaireXF
{
    public class Bootstrapper : SinglePlayerBootstrapper<KlondikeSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<KlondikeSolitaireShellViewModel>(); //hopefully okay.

...
{
    public class GamePage : SinglePlayerGamePage<KlondikeSolitaireViewModel>
    {
        ...
        protected override async Task AfterGameButtonAsync()
        {
            ...
            var autoBut = GetSmallerButton("Auto Make Move", nameof(KlondikeSolitaireViewModel.AutoMoveCommand));

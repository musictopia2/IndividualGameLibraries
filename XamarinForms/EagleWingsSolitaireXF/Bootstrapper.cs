...
{
    public class Bootstrapper : SinglePlayerBootstrapper<EagleWingsSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<EagleWingsSolitaireShellViewModel>(); //hopefully okay.

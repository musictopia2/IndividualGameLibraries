...
{
    public class Bootstrapper : SinglePlayerBootstrapper<AlternationSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<AlternationSolitaireShellViewModel>(); //hopefully okay.

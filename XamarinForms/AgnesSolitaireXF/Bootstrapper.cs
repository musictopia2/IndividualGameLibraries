...
{
    public class Bootstrapper : SinglePlayerBootstrapper<AgnesSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<AgnesSolitaireShellViewModel>(); //hopefully okay.

...
{
    public class Bootstrapper : SinglePlayerBootstrapper<SpiderSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<SpiderSolitaireShellViewModel>(); //hopefully okay.

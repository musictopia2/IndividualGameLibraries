...
{
    public class Bootstrapper : SinglePlayerBootstrapper<DemonSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<DemonSolitaireShellViewModel>(); //hopefully okay.

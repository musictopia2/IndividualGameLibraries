...
{
    public class Bootstrapper : SinglePlayerBootstrapper<BlockElevenSolitaireShellViewModel, GamePage>
    {
        ...
        {
            OurContainer!.RegisterNonSavedClasses<BlockElevenSolitaireShellViewModel>(); //hopefully okay.
